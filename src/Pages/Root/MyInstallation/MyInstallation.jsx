                                ...
                                <div className="md:w-3/4 flex flex-col justify-between h-full">
                                    <div>
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:gap-4 mt-2 text-gray-700 text-sm">
                                            ...
                                            <p><strong>Downloads:</strong> {app.downloads?.toLocaleString() || 0}</p>
                                            <p><strong>Rating:</strong> {app.ratingAvg}★ ({app.reviews?.toLocaleString() || 0} reviews)</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-4 md:mt-0 md:flex md:justify-end">
                                        <button
                                            ...
                                            className="px-6 py-2 bg-gradient-to-r from-[#54CF68] to-[#00827A] text-white rounded hover:opacity-90 transition"
                                        >
                                            Uninstall
                                        </button>
                                    </div>
